...
<title style = 'background-color:#232323;'>Sneaker Source - Product Information</title>
...
try(Connection conn = DriverManager.getConnection(url,userN,pw);
    ...
    String sql = "SELECT productId, productName, productPrice, productImageURL, productImage, productDesc FROM product WHERE productId LIKE ?";
    ...
    if(rs.next()){
        ...
        out.println("<h3> Description: "+rs.getString(6)+"</h3>");
